      ...
      <div className="absolute top-6 left-14 z-10 flex items-center gap-1">
        ...
        <span className="text-lg font-semibold tracking-wide">FERENJE</span>
                ...
                <div className="z-10 max-w-md mt-96 mr-12">
                    ...
                    <h1 className="text-3xl  font-bold mb-4  leading-tight tracking-tight">FERENJE HCMS SYSTEM</h1>
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
                <div className="w-full max-w-[440px]">
                    <div className="mb-10">
                        <h2 className="text-3xl  font-extrabold text-gray-800 mb-2 tracking-tight">Welcome Back To Ferenje</h2>
